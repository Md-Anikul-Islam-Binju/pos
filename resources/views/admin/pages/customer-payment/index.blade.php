...
@section('admin_content')
            ...
            <div class="card-header">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    @can('customer-payment-create')
                        <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#addPaymentModal">Add Customer Payment</button>
                    @endcan
                ...
                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    @foreach($payment as $key => $pay)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('customer.payment.update.status', [$pay->id, '']) }}" method="GET">
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" action="{{ route('customer.payment.update', $pay->id) }}" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="row">
                                                <div class="col-6 mb-3">
                                                    ...
                                                    <select name="customer_id" class="form-select" required>
                                                        ...
                                                        @foreach($customer as $c)
                                                            <option value="{{ $c->id }}" {{ $c->id == $pay->customer_id ? 'selected' : '' }}>{{ $c->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-6 mb-3">
                                                ...
                                                <div class="col-6 mb-3">
                                                    ...
                                                    <input type="text" name="received_by" class="form-control" value="{{ $pay->received_by }}">
                                                </div>
                                                <div class="col-6 mb-3">
                                                ...
                                                <div class="col-6 mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="old_photo" value="{{ $pay->image }}" class="d-none">
                                                        <input name="photo" type="file" class="form-control" id="photo">
                                                    </div>
                                                    @if($pay->image)
                                                        <div class="form-group mb-2">
                                                            <img src="{{ asset($pay->image) }}" alt="Current Image" width="100">
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        @can('customer-payment-delete')
                                            <a href="{{ route('customer.payment.destroy', $pay->id) }}" class="btn btn-danger">Delete</a>
                                        @endcan
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="addPaymentModal" tabindex="-1" aria-labelledby="addPaymentLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="addPaymentLabel">Add Customer Payment</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
