                                    ...
                                    <div class="modal-body">
                                        <form method="post" action="{{route('color.update',$colorData->id)}}" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="mb-3">
                                                        <label for="example-select" class="form-label">Color Code (Hexadecimal)</label>
                                                        <input type="text" id="color_code" name="color_code" value="{{$colorData->color_code}}"
                                                               class="form-control" placeholder="Enter Color Code" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
