        ...
        <div class="card">
            ...
            <div class="card-body">
                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    <tbody>
                    @foreach($brand as $key=>$employeeData)
                        <tr>
                            <td>{{$key+1}}</td>
                            ...
                            <td>{{$employeeData->registration_date}}</td>
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="post" action="{{route('color.update',$employeeData->id)}}" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                <div class="row">
                                                    <div class="col-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="date" id="dob" name="dob" value="{{$employeeData->dob}}"
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="date" id="registration_date" name="registration_date" value="{{$employeeData->registration_date}}"
                                                                   class="form-control" required>
                                                        </div>
                                                    </div>
                                                </div>
