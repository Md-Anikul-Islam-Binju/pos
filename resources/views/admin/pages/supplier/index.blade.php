                ...
                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    @foreach($supplier as $key=>$supplierData)
                        <tr>
                            ...
                            <td>{{ $supplierData->contact_person }}</td>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="contact_person" name="contact_person" value="{{ $supplierData->contact_person }}"
                                                                   class="form-control" placeholder="Enter Contact Person's Name" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="tel" id="phone" name="phone" value="{{ $supplierData->phone }}"
