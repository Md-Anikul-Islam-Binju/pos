                ...
                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                    ...
                    @foreach($currency as $key=>$currencyData)
                        <tr>
                            ...
                            <td>{{$currencyData->suffix}}</td>
                            <td>{{$currencyData->prefix}}</td>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="code" name="code" value="{{$currencyData->code}}"
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" id="rate" name="rate" value="{{$currencyData->rate}}"
                                                    ...
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="suffix" name="suffix" value="{{$currencyData->suffix}}"
                                                                   class="form-control" placeholder="Enter Suffix" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="prefix" name="prefix" value="{{$currencyData->prefix}}"
