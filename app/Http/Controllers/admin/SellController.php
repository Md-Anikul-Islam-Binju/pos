...
class SellController extends Controller
{
    public function index(): View|Factory|Application
    {
        ...
        return view('admin.pages.sell.index', compact('sells'));
    }
    ...
    public function create(): View|Factory|Application
    {
        ...
        return view('admin.pages.sell.create',
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        if (!$selectedCurrency) {
            return redirect()->route('sells.create')->with('error','Currency not found');
        }
    ...
    public function edit($id)
    {
        ...
        return view('admin.pages.sell.edit',
    ...
    public function show($id): View|Factory|Application
    {
        ...
        return view('admin.pages.sell.show', compact('sell', 'admins', 'activities', 'existingProducts'));
    }
    ...
    public function showInvoice($id) {
        ...
        return view('admin.pages.sell.invoice', compact('sell', 'existingProducts'));
    }
}
